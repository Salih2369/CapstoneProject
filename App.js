      ...
      <AnimatePresence mode="wait">
        <Routes location={location} key={location.pathname}>
          ...
          <Route
            ...
            element={
              <RequireOnboarding>
                {flags.settings ? <RouteShell><Settings /></RouteShell> : <Navigate to="/dashboard" replace />}
              </RequireOnboarding>
            }
          />
          ...
          <Route
            ...
            element={
              <RequireOnboarding>
                {flags.alerts ? <RouteShell><Alerts /></RouteShell> : <Navigate to="/dashboard" replace />}
              </RequireOnboarding>
            }
          />
          ...
          <Route
            ...
            element={
              <RequireOnboarding>
                {flags.branches ? <RouteShell><Branches /></RouteShell> : <Navigate to="/dashboard" replace />}
              </RequireOnboarding>
            }
          />
          ...
          <Route
            ...
            element={
              <RequireOnboarding>
                {flags.reports ? <RouteShell><Reports /></RouteShell> : <Navigate to="/dashboard" replace />}
              </RequireOnboarding>
            }
          />
          ...
          <Route
            ...
            element={
              <RequireOnboarding>
                {flags.usersAdmin ? <RouteShell><AdminUsers /></RouteShell> : <Navigate to="/dashboard" replace />}
              </RequireOnboarding>
            }
          />
